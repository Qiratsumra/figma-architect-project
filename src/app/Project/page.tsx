...
<br />
            ...
            <div className="max-sm:inline-block ">
                <div className="w-[1170px] h-[435px] bg-slate-200 flex justify-around m-5 max-sm:w-[350px] max-sm:h-[245px] max-sm:m-10 max-sm:inline ">
                    <Image src={card1} alt="card1-image"></Image>
                    <div className="pl-6">
                        
                        <h1 className="text-gray-400 text-4xl pt-5 max-sm:text-xl ">Simple Project No.1</h1>
                    <p className="pt-10 text-slate-400 max-sm:text-xs max-sm:p-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis assumenda voluptatum veniam ipsa eius, maxime reiciendis consectetur nihil voluptatibus minima, hic quas? Odio laboriosam illum optio praesentium cupiditate error quis. Modi, optio. Nam ab dolore dolor accusantium natus debitis, cupiditate culpa enim aperiam ratione sed, quaerat molestias totam inventore explicabo.</p>
                   
                    <button className="bg-slate-50 mt-28 h-10 w-24 max-sm:mt-10 max-sm:h-3:">View More ➡</button>
                    </div>
                                  </div>
                <div className="w-[1170px] h-[435px]  bg-slate-200 flex justify-around m-5 max-sm:w-[350px] max-sm:h-[245px] max-sm:m-10 max-sm:inline">
                    <Image src={card2} alt="card2-image"></Image>
                <div className="pl-6">
                        
                        <h1 className="text-gray-400 text-4xl pt-5 max-sm:text-xl ">Simple Project No.2</h1>
                    <p className="pt-10 text-slate-400 max-sm:text-xs max-sm:p-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis assumenda voluptatum veniam ipsa eius, maxime reiciendis consectetur nihil voluptatibus minima, hic quas? Odio laboriosam illum optio praesentium cupiditate error quis. Modi, optio. Nam ab dolore dolor accusantium natus debitis, cupiditate culpa enim aperiam ratione sed, quaerat molestias totam inventore explicabo.</p>
                    <button className="bg-slate-50 mt-28 h-10 w-24">View More ➡</button></div>                        
                </div>
                <div className="w-[1170px] h-[435px]  bg-slate-200 flex justify-around m-5 max-sm:w-[350px] max-sm:h-[245px] max-sm:m-10 max-sm:inline">
                    <Image src={card3} alt="card3-image"></Image>
                <div className="pl-6">
                        
                        <h1 className="text-gray-400 text-4xl pt-5 max-sm:text-xl ">Simple Project No.3</h1>
                    <p className="pt-10 text-slate-400 max-sm:text-xs max-sm:p-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis assumenda voluptatum veniam ipsa eius, maxime reiciendis consectetur nihil voluptatibus minima, hic quas? Odio laboriosam illum optio praesentium cupiditate error quis. Modi, optio. Nam ab dolore dolor accusantium natus debitis, cupiditate culpa enim aperiam ratione sed, quaerat molestias totam inventore explicabo.</p>
                    <button className="bg-slate-50 mt-28 h-10 w-24">View More ➡</button></div>
                </div>
            </div>
